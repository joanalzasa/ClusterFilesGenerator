...
public class rocksCppRunFilesLoop20 {
...
//		BufferedWriter br = new BufferedWriter(new FileWriter("./rocks/runBatch20_5.txt"));
		BufferedWriter br = new BufferedWriter(new FileWriter("./rocks/runBatch20_10.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./rocks/runBatch20_20.txt"));
		br.write(out);
		br.close();
	}
