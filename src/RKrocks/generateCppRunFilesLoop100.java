...
//		double[] coolingParams = { 0.025 };
		...
		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch100_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch100_10.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch100_20.txt"));
		br.write(out);
		br.close();
	}
