...
public class rocksCppRunFilesLoop100 {
...
//		BufferedWriter br = new BufferedWriter(new FileWriter("./rocks/runBatch100_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./rocks/runBatch100_10.txt"));
		BufferedWriter br = new BufferedWriter(new FileWriter("./rocks/runBatch100_20.txt"));
		br.write(out);
		br.close();
	}
