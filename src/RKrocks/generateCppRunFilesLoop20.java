...
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch20_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch20_10.txt"));
		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch20_20.txt"));
		br.write(out);
		br.close();
	}
