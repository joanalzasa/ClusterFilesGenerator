...
//				"dynProfile-n200-c20-Cayley2.txt", "dynProfile-n200-c20-Cayley40.txt","dynProfile-n200-c20-Cayley100.txt", "dynProfile-n200-c20-Cayley180.txt"
		...
		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch200_10.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/rocks/RKEDA/runBatch200_20.txt"));
		br.write(out);
		br.close();
	}
