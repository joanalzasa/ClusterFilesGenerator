...
public class generateJavaRunFilesLoop50 {
...
//				"data/taillard_instances/tai50_20_8.fsp","data/taillard_instances/tai50_20_9.fsp"};
		...
		BufferedWriter br = new BufferedWriter(new FileWriter("./javaFiles/runBatch50_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./javaFiles/runBatch50_10.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./javaFiles/runBatch50_20.txt"));
		br.write(out);
		br.close();
	}
