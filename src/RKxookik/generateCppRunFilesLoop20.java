...
//				"dynProfile-n20-c20-Cayley4.txt"
		...
		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/RKEDA/runBatch20_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/RKEDA/runBatch20_10.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/RKEDA/runBatch20_20.txt"));
		br.write(out);
		br.close();
	}
