...
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/DRKEDA/runBatch100_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/DRKEDA/runBatch100_10.txt"));
		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/DRKEDA/runBatch100_20.txt"));
		br.write(out);
		br.close();
	}
