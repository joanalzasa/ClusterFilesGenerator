...
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/DRKEDA/runBatch50_5.txt"));
//		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/DRKEDA/runBatch50_10.txt"));
		BufferedWriter br = new BufferedWriter(new FileWriter("./cppFiles/DRKEDA/runBatch50_20.txt"));
		br.write(out);
		br.close();
	}
